    ...
    _Outptr_result_bytebuffer_(Length) VOID**              VirtualAddress)
{
    ...
    BDD_PROBE2("MapFrameBuffer request physical=0x%I64x bytes=%u",
    ...
    *VirtualAddress = MmMapIoSpaceEx(PhysicalAddress,
    ...
    BDD_PROBE1("MapFrameBuffer success cpuPtr=0x%I64x",
               (ULONGLONG)(ULONG_PTR)*VirtualAddress);
    ...
    _In_                ULONG Length)
{
    ...
    BDD_PROBE2("UnmapFrameBuffer cpuPtr=0x%I64x bytes=%u",
               (ULONGLONG)(ULONG_PTR)VirtualAddress,
               Length);
