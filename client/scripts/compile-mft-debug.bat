...
cl.exe -nologo -MT -O2 -Brepro %INC% /std:c++20 /EHsc -DNOMINMAX -DWEBRTC_WIN -DUSE_MFT_VIDEO_CODEC=1 -DUSE_AURA=1 -D_HAS_EXCEPTIONS=0 -D_WINDOWS -DWIN32 -DWIN32_LEAN_AND_MEAN -D_UNICODE -DUNICODE -DNDEBUG -DWEBRTC_USE_H264 -DWEBRTC_LIBRARY_IMPL -DCHROMIUM -DLIBYUV_DISABLE_NEON -DWEBRTC_WIN -c src/mft/mft_h264_decoder_impl.cpp 2>&1
