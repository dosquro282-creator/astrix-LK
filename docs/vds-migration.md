...
Текущий VDS IP: `104.128.136.203`

## Что уже перенастроено в проекте

- Клиент по умолчанию использует API: `http://104.128.136.203:8080`
...
- LiveKit в `docker-compose.yml` уже настроен на `ws://104.128.136.203:7880`
...
```json
{
  "api_base": "http://104.128.136.203:8080"
}
```
