...
//
// driver_probe R&D tracing.
//
// Keep this separate from the sample's original BDD_LOG_* macros: those macros
// intentionally compile away in the Microsoft sample, while these probe lines
// are the only diagnostics added for the display-driver-level capture check.
//
#define BDD_PROBE_PREFIX "[driver_probe][KMDOD] "

#define BDD_PROBE0(Msg) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, BDD_PROBE_PREFIX Msg "\n")
#define BDD_PROBE1(Msg,Param1) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, BDD_PROBE_PREFIX Msg "\n", Param1)
#define BDD_PROBE2(Msg,Param1,Param2) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, BDD_PROBE_PREFIX Msg "\n", Param1, Param2)
#define BDD_PROBE3(Msg,Param1,Param2,Param3) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, BDD_PROBE_PREFIX Msg "\n", Param1, Param2, Param3)
#define BDD_PROBE4(Msg,Param1,Param2,Param3,Param4) \
    DbgPrintEx(DPFLTR_IHVVIDEO_ID, DPFLTR_INFO_LEVEL, BDD_PROBE_PREFIX Msg "\n", Param1, Param2, Param3, Param4)
#define BDD_PROBE5(Msg,Param1,Param2,Param3,Param4,Param5) \
